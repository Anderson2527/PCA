...
import scala.math._ // Para funciones matemáticas
...
object pruebaScala {
  def main(args: Array[String]) {
    ...
    while (op != "PCyA") {
      ...
      if (op == "P") {
        println("\n La tecla que has introducido forma parte del conjunto de teclas magicas y es la que esta en la  1ª posicion (Total del conjunto 4 letras)")
      } else if (op == "C") {
        println("\n La tecla que has introducido forma parte del conjunto de teclas agicas y es la que esta en la  2ª posicion (Total del conjunto 4 letras)")
      } else if (op == "y") {
        println("\n La tecla que has introducido forma parte del conjunto de teclas magicas y es la que esta en la  3ª posicion (Total del conjunto 4 letras)")
      } else if (op == "A") {
        println("\n La tecla que has introducido forma parte del conjunto de teclas magicas y es la que esta en la  4ª y ultima posicion (Total del conjunto 4 letras)")
      } else {
